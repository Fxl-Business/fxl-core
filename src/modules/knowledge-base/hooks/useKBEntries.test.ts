...
// ---------------------------------------------------------------------------
// Mock kb-service — use actual exported names from src/lib/kb-service.ts
// ---------------------------------------------------------------------------

const mockListKnowledgeEntries = vi.fn()
...
describe('useKBEntries', () => {
  ...
  it('filters by tags with serialized dependency', async () => {
    ...
    expect(mockListKnowledgeEntries).toHaveBeenCalledWith({ tags: ['supabase'] })
  })
