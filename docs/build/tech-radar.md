...
| Status | Significado |
|---|---|
| ✅ Ativo | Tecnologia adotada. Use em todos os projetos elegiveis. |
| ⚠️ Excecao | Permitida em casos especificos. Justificativa obrigatoria no README. |
| 🔵 Em avaliacao | Em uso experimental ou piloto. Nao adotar em novos projetos sem consulta. |
| ⬜ TBD | Identificada como relevante. Decisao pendente. |
