...
User has a `blueprint-export.json` from the FXL Wireframe Builder and wants to create a full spoke project from it. This builds on `rules/new-project.md` — follow that first for base scaffold, then apply blueprint-specific generation.
...
Follow `rules/new-project.md` steps 1-8 using:
