...
After running an audit (`rules/audit.md`), use these patterns to incrementally bring a project into FXL compliance. Designed for migrating Lovable-generated projects or other existing codebases.
...
Follow `rules/connect.md` for detailed instructions.

### Step 8: Add CI/CD

**Goal:** Set up GitHub Actions and Vercel deploy.

Follow `rules/ci-cd.md` and `rules/deploy.md`.
