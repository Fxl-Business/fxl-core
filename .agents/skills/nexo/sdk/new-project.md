...
Create API route handlers for all required endpoints. See `sdk/connect.md` for detailed endpoint implementation.
...
See `sdk/ci-cd.md` for GitHub Actions setup.

### 14. Set Up Deploy

See `sdk/deploy.md` for Vercel configuration.
