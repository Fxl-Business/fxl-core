...
- [x] **Phase 117: Access Control Lockdown** - Remove self-service org creation and add unaffiliated user screen
- [x] **Phase 118: Admin User Management** - Unaffiliated users filter, search, and org linking from admin panel
- [x] **Phase 119: Tenant Archival** - Soft-delete with restore capability and archived tenants visibility
- [x] **Phase 120: Admin Dashboard Improvements** - Unaffiliated and archived counts with quick action links
...
Plans:
- [x] 117-01-PLAN.md — Create SolicitarAcesso page (new branded holding screen)
- [x] 117-02-PLAN.md — Remove CriarEmpresa, update router and ProtectedRoute redirect
...
Plans:
- [x] 118-01-PLAN.md — UsersPage filter (Todos/Sem org/Com org) and org assignment dialog
- [x] 118-02-PLAN.md — TenantDetailPage user search combobox replacing raw userId input
...
Plans:
- [x] 119-01-PLAN.md — DB migration: archived_at column + RLS policies
- [x] 119-02-PLAN.md — Edge function: archive/restore actions + status filtering
- [x] 119-03-PLAN.md — Frontend: types, services, TenantsPage tabs, archive button
...
Plans:
- [x] 120-01-PLAN.md — Add unaffiliated users + archived tenants metric cards with navigation
...
|-------|----------------|--------|-----------|
| 117. Access Control Lockdown | 2/2 | Complete | 2026-03-18 |
| 118. Admin User Management | 2/2 | Complete | 2026-03-18 |
| 119. Tenant Archival | 3/3 | Complete | 2026-03-18 |
| 120. Admin Dashboard Improvements | 1/1 | Complete | 2026-03-18 |
