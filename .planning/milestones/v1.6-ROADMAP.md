...
- [x] **Phase 34: Wave 1 — ChartType Sub-Variants** (2/2 plans) - 7 new chartType values via Extension Point A (4-point atomic sync per chart)
- [x] **Phase 35: Wave 2 — Standalone Section Types** (2/2 plans) - 4 new standalone sections via Extension Point B (5-file checklist per type)
- [x] **Phase 36: Wave 3 — Sankey Diagram** (1/1 plan) - Sankey as final standalone section with pre-build Recharts export verification
- [x] **Phase 37: Finalization — Gallery & Cross-Cutting** (2/2 plans) - ComponentGallery updated with all 12 new types and mock data
...
Plans:
- [x] 34-01: Schema Extension + Grouped Bar, Step Line, Lollipop, Polar (3 tasks) — completed
- [x] 34-02: Bullet Chart, Range Bar, and Bump Chart (2 tasks) — completed
...
Plans:
- [x] 35-01: Pie Chart & Progress Grid (type + schema + component + renderer + form + registry) — completed
- [x] 35-02: Heatmap & Sparkline Grid + test update to 27 entries — completed
...
Plans:
- [x] 36-01: Sankey Diagram — Export Verification, Component, Schema & Registry — completed
...
Plans:
- [x] 37-01: Gallery Mock Data & Component Entries — completed
- [x] 37-02: Visual Validation — Light/Dark Mode & Milestone Gate — completed
...
| 34. Wave 1 ChartType Sub-Variants | v1.6 | 2/2 | Complete | 2026-03-12 |
| 35. Wave 2 Standalone Section Types | v1.6 | 2/2 | Complete | 2026-03-12 |
| 36. Wave 3 Sankey Diagram | v1.6 | 1/1 | Complete | 2026-03-12 |
| 37. Finalization Gallery & Cross-Cutting | v1.6 | 2/2 | Complete | 2026-03-13 |
