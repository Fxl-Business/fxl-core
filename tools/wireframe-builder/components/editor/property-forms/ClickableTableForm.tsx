...
type Props = {
  section: ClickableTableSection
  onChange: (updated: ClickableTableSection) => void
}
...
export default function ClickableTableForm({ section, onChange }: Props) {
  ...
  return (
    <div className="space-y-4">
      <div>
        <Label htmlFor="clickable-title">Titulo</Label>
        <Input
          id="clickable-title"
          value={section.title}
      ...
      <div>
        <Label htmlFor="clickable-subtitle">Subtitulo</Label>
        <Input
          id="clickable-subtitle"
