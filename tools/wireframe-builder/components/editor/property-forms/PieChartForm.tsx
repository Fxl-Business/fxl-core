...
import type { PieChartSection } from '@tools/wireframe-builder/types/blueprint'

type Props = {
  section: PieChartSection
  onChange: (updated: PieChartSection) => void
}

export default function PieChartForm({ section, onChange }: Props) {
  ...
  return (
    <div className="space-y-4">
      <div>
        <Label htmlFor="pie-title">Titulo</Label>
        <Input
          id="pie-title"
          value={section.title}
      ...
      <div>
        <Label htmlFor="pie-height">Altura (px)</Label>
        <Input
          id="pie-height"
          type="number"
