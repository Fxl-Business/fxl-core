...
- **Global scope**: `/Users/cauetpinciara/Documents/fxl/Projetos/fxl-core/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/cauetpinciara/Documents/fxl/Projetos/fxl-core/.claude/notes/`)
...
2. Glob `/Users/cauetpinciara/Documents/fxl/Projetos/fxl-core/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/cauetpinciara/Documents/fxl/Projetos/fxl-core/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/cauetpinciara/Documents/fxl/Projetos/fxl-core/.claude/notes/` — works in any directory
