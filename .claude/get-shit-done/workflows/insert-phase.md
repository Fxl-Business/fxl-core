...
```bash
INIT=$(node "/Users/cauetpinciara/Documents/fxl/Projetos/fxl-core/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${after_phase}")
...
```bash
RESULT=$(node "/Users/cauetpinciara/Documents/fxl/Projetos/fxl-core/.claude/get-shit-done/bin/gsd-tools.cjs" phase insert "${after_phase}" "${description}")
```
