...
```bash
node "/Users/cauetpinciara/Documents/fxl/Projetos/fxl-core/.claude/get-shit-done/bin/gsd-tools.cjs" validate health $REPAIR_FLAG
```
...
```bash
node "/Users/cauetpinciara/Documents/fxl/Projetos/fxl-core/.claude/get-shit-done/bin/gsd-tools.cjs" validate health
```
